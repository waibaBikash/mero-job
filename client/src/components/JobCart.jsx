       ...
       <h4 className='font-medium text-xl mt-2'>{job.title}</h4>
        <div className='flex items-center gap-3 mt-2 text-xs'>
         ...
         <div className='mt-4 flex gap-4 text-sm'>
           <button className='bg-blue-600 text-white px-4 py2 rounded'>Apply now</button>
           <button className='text-gray-500 border border-r-gray-500 rounded px-4 py-2  '>Learn more</button>
         </div>
    </div>
  )
}
